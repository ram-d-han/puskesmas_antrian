...
class TbPasien extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['nama_pasien', 'nama_kk', 'hub_keluarga', 'no_bpjs', 'tgl_lahir', 'umur', 'jenis_kelamin', 'alamat', 'no_index', 'pendidikan', 'pekerjaan', 'agama', 'status_pernikahan', 'telepon', 'tgl_masuk', 'token'], 'required'],
            [['no_bpjs', 'umur'], 'integer'],
            [['tgl_lahir', 'tgl_masuk'], 'safe'],
            [['nama_pasien', 'nama_kk', 'alamat'], 'string', 'max' => 50],
            [['hub_keluarga', 'agama', 'status_pernikahan'], 'string', 'max' => 20],
