...
class TbPasien extends \yii\db\ActiveRecord
{
     ...
     *
     * @return \yii\db\ActiveQuery|\common\models\API\query\TbRekamMedisQuery
     */
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\API\query\TbAdminQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\API\query\TbAdminQuery(get_called_class());
    }
}
