...
<head>
    ...
    <style type="text/css">
      .navbar {
        background-color: #4e35e7 !important;
      }
      .nav-link, .navbar-brand {
        color: white !important;
      }
      .nav-link:hover {
        background-color: #3e24e6;
      }
      .jumbotron {
...
<div class="main-content">
    <!-- Navbar -->
<?php
  if (Yii::$app->user->identity->hak_akses == 'super admin') {
    $menuItems = [
      ['label' => 'Dashboard', 'url' => ['/site/index']],
      ['label' => 'Admin', 'url' => ['/admin/index']],
      ['label' => 'Pasien', 'url' => ['/tb-pasien/index']],
      ['label' => 'Rekam Medis', 'url' => ['/tb-rekam-medis/index']],
      ['label' => 'Daftar Kategori', 'url' => ['/tb-daftar-kategori/index']],
      ['label' => 'Info', 'url' => ['/tb-info/index']],
      ['label' => 'Poli', 'url' => ['/tb-poli/index']],
      ['label' => 'Antrian Sekarang', 'url' => ['/tb-antrian-now/index']],
      ['label' => 'Sign Out', 'url' => ['/site/logout'], 'linkOptions' => ['data' => ['method' => 'post']]],
    ];
  }

  if (Yii::$app->user->identity->hak_akses == 'admin') {
    $menuItems = [
      ['label' => 'Dashboard', 'url' => ['/site/index']],
      ['label' => 'Pasien', 'url' => ['/tb-pasien/index']],
      ['label' => 'Rekam Medis', 'url' => ['/tb-rekam-medis/index']],
