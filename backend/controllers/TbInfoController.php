...
/**
 * TbInfoController implements the CRUD actions for TbInfo model.
 */
class TbInfoController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Deletes an existing TbInfo model.
